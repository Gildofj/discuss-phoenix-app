defmodule DiscussWeb.CoreComponents do
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 py-4 px-16 rounded-lg font-semibold bg-purple-500 text-white hover:bg-purple-700 hover:duration-500",
        @class
      ]}
      {@rest}
    >
  ...
  def input(assigns) do
    ...
    <div phx-feedback-for={@name} class="md:w-[28rem] w-full">
      ...
      <input
        ...
        class={[
          "border-2 rounded border-none bg-purple-200 w-full max-w-md h-14 focus:ring-purple-700",
          @errors != [] && "border-rose-400 focus:border-rose-400"
        ]}
        {@rest}
      />
